...
![可以看到大部分计算资源在colorpass上](/images/posts/9568ade9.png)
...
![整个Pass中没有启用高级Shader](/images/posts/2df8a9f9.png)
...
![第一个Pass，记录摄像机的深度。可以剔除像素防止overdraw](/images/posts/e89f1e09.png)

![第二个pass。很明显是日光渲染的深度图，一眼Shadowmap的阴影采样，和摄像机的深度图配合就可以出阴影了](/images/posts/8bcc45bc.png)

看完了深度测试就可以知道了，采用的是shadowmap形式。

![](/images/posts/f7f4ee31.png)

![](/images/posts/f8bfbc9a.png)
...
![双阶段Pass，有很明显的分工](/images/posts/cb138439.png)

挑一个第二个pass末状态下的backbuffer看一下里边有什么：

![](/images/posts/e6c9adc0.png)
...
![通用场景使用base、Bump、ILM。](/images/posts/632c9945.png)
...
![](/images/posts/45cc1723.png)

特异型场景Shader则会使用比较特殊的贴图，全部在二阶段才会渲染。

![](/images/posts/fcb18d6f.png)
...
![](/images/posts/f9dce9a2.png)![](/images/posts/070abae4.png)
...
![](/images/posts/be11bc30.png)

树叶的状态输入：

+  _LSABMap = birch02_leaf_diff  
 ![](/images/posts/a1688cf5.png)
...
![](/images/posts/c6269f2e.png)![](/images/posts/52d364ff.png)![](/images/posts/6c148b6f.png)![](/images/posts/503a9d5d.png)
...
![占据人物最大的衣服比例只有14964的顶点引用](/images/posts/7aca77e1.png)
...
+ Mipmap有11级，还行![](/images/posts/b14cad11.png)
