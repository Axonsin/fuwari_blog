...
假设Gamma值为2.2（常见标准），输入线性亮度值为 ![image](/images/posts/d3a6c2bc.svg)，输出Gamma编码值为 ![image](/images/posts/a098efef.svg)：  

![image](/images/posts/c5a412d0.svg)

**暗部**：  

假设线性亮度 ![image](/images/posts/6c4db7a8.svg)（10%亮度），则Gamma编码值为：

![image](/images/posts/57fb659b.svg)

在Gamma空间中，0.1的亮度被映射到像素值91，而非线性空间中的0.1亮度对应像素值25.5（25.5 × 0.1 = 2.55）。显然，Gamma空间中暗部的灰阶被拉伸了。

**亮部**：  

线性亮度 ![image](/images/posts/607d6716.svg)（90%亮度），Gamma编码值为：

![image](/images/posts/0ca41ed7.svg)
